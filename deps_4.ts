 ...
 *
 * 分析index.js思路
 * - 初始化文件的依赖对象  {deps:[], code:'index.js's code'}
 * - 把index.js code 变成ast
 * - 遍历ast 查看import的依赖的文件，加入依赖了a.js b.js
 * - 把a.js b.js 写到depRelation['index.js'].deps里
 */
